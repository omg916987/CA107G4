...
<html>
<head>
<title>IBM InsCourse: Home</title>
...
<table id="table-1">
   <tr><td><h3>IBM InsCourse: Home</h3><h4>( MVC )</h4></td></tr>
</table>

<p>This is the Home page for IBM InsCourse: Home</p>
...
<ul>
  ...
  <li>
     <FORM METHOD="post" ACTION="InsCourse.do" >
       <b>選擇課程編號:</b>
       <select size="1" name="inscId">
         <c:forEach var="InsCourseVO" items="${InsCourseSVC.all}" > 
...
<ul>
  <li><a href='addInsCourse.jsp'>Add</a> a new InsCourse.</li>
</ul>
