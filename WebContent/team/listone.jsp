	...
	<FORM METHOD="GET" ACTION="/CA107G4/team/team.do" name="form2">
		<div class="form-row">
			...
			<div class="form-group col-md-6">
				<label for="inputPassword4">揪團編號</label> <input type="text"
					class="form-control" id="inputPassword4" name="leaderID" value="${joinGroupVO.TeamId}"
					placeholder="揪團會員編號">
			</div>

			<div class="form-group col-md-6">
				<label for="inputPassword4">交易帳號</label> <input type="text"
					class="form-control" id="inputPassword4" name="inscID" value="${joinGroupVO.memId}"
					placeholder="請輸入課程編號">
			</div>
		</div>
		<div class="form-row">
			<div class="form-group col-md-6">
				<label for="date">預扣金額</label> <input class="form-control"
					type="date" id="teamMFD" name="temaMFD" page[end_date]="">
			</div>
                   
			<div class="form-group col-md-6">
				<label for="date">交易日期</label> <input class="form-control"
