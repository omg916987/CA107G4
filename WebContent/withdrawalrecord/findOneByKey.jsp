...
<%
   WithdrawalRecordVO withdrawalRecordVO = (WithdrawalRecordVO) request.getAttribute("withdrawalRecordVO"); //EmpServlet.java(Concroller), 存入req的empVO物件
%>
	...
	<ul>
		...
		<table class="table table-bordered track_tbl">
          ...
          <jsp:useBean id="withdrawalRecorSvc" scope="page" class="com.withdrawalrecord.model.WithdrawalRecordService" />
				...
				<c:remove var="withdrawalRecordVO" scope="page"/>
